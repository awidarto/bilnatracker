...
return array(
        ...
        'default_export_heads'=>array(
            ...
            array('Order ID',array('search'=>true,'sort'=>true)),
            array('Pick up date',array('search'=>true,'sort'=>true, 'style'=>'min-width:90px;','daterange'=>true)),
            array('Trip',array('search'=>true,'sort'=>true)),
            array('Fulfillment id',array('search'=>true,'sort'=>true)),
            array('Number of package',array('search'=>true,'sort'=>true)),
            array('Cod value',array('search'=>true,'sort'=>true)),
            array('Email',array('search'=>true,'sort'=>true)),
        ...
        'default_dispatched_heads'=>array(
            ...
            array('STATUS',array('search'=>true,'select'=>Ks::statusoptions() ,'style'=>'min-width:175px;','sort'=>true)),
            array('3PL STATUS',array('search'=>true,'sort'=>true)),
            array('CURR POSITION',array('search'=>true,'select'=>Prefs::getPosition()->PositionToSelection('node_code','name') ,'sort'=>true)),
            array('PENDING COUNT',array('search'=>true,'sort'=>true)),
            array('LAST ACTION',array('search'=>true,'sort'=>true)),
        ...
        'default_dispatched_fields'=>array(
            ...
            array('last_action',array('kind'=>'text' , 'query'=>'like', 'pos'=>'both','show'=>true)),
        ...
        'default_dispatched_export_heads'=>array(
            array('CREATED DATE',array('search'=>true,'sort'=>true, 'style'=>'min-width:90px;','daterange'=>true)),
            array('PICK UP DATE',array('search'=>true,'sort'=>true, 'style'=>'min-width:120px;','daterange'=>true)),
            array('TRIP',array('search'=>true,'sort'=>true, 'style'=>'min-width:120px;','daterange'=>true)),
            array('DEVICE NAME',array('search'=>true,'style'=>'min-width:120px;','sort'=>true)),
            array('COURIER NAME',array('search'=>true,'style'=>'min-width:120px;','sort'=>true)),
            array('STATUS',array('search'=>true,'select'=>Ks::statusoptions() ,'style'=>'min-width:175px;','sort'=>true)),
            array('COURIER STATUS',array('search'=>true,'select'=>Ks::statusoptions() ,'style'=>'min-width:175px;','sort'=>true)),
            array('HUB STATUS',array('search'=>true,'select'=>Ks::statusoptions() ,'style'=>'min-width:175px;','sort'=>true)),
            array('3PL STATUS',array('search'=>true,'sort'=>true)),
            array('CURR POSITION',array('search'=>true,'select'=>Prefs::getPosition()->PositionToSelection('node_code','name') ,'sort'=>true)),
            array('PENDING COUNT',array('search'=>true,'sort'=>true)),
            array('LAST ACTION',array('search'=>true,'sort'=>true)),
        ...
        'default_dispatched_export_fields'=>array(
            ...
            array('device_name',array('kind'=>'text' , 'query'=>'like', 'pos'=>'both','show'=>true)),
            array('courier_name',array('kind'=>'text' , 'query'=>'like', 'pos'=>'both','show'=>true)),
            array('status',array('kind'=>'text', 'callback'=>'transStatus','query'=>'like','pos'=>'both','show'=>true, 'multi'=>array('status','warehouse_status','pickup_status'), 'multirel'=>'OR'  )),
            array('courierStatus',array('kind'=>'text','callback'=>'transCrStatus','query'=>'like','pos'=>'both','show'=>true, 'multi'=>array('status','warehouse_status','pickup_status'), 'multirel'=>'OR'  )),
            array('warehouseStatus',array('kind'=>'text','callback'=>'transHubStatus','query'=>'like','pos'=>'both','show'=>true, 'multi'=>array('status','warehouse_status','pickup_status'), 'multirel'=>'OR'  )),
            array('logistic_status',array('kind'=>'text' , 'query'=>'like', 'pos'=>'both','show'=>true)),
            array('position',array('kind'=>'text' , 'query'=>'like', 'pos'=>'both','show'=>true)),
            array('pending_count',array('kind'=>'numeric' , 'query'=>'like', 'pos'=>'both','show'=>true)),
            array('last_action',array('kind'=>'text' , 'query'=>'like', 'pos'=>'both','show'=>true)),
        ...
        'default_delivered_heads'=>array(
            ...
            array('STATUS',array('search'=>true,'select'=>Ks::statusoptions() ,'style'=>'min-width:175px;','sort'=>true)),
            array('3PL STATUS',array('search'=>true,'sort'=>true)),
            array('3PL PICK UP',array('search'=>true,'sort'=>true)),
            array('3PL NOTE',array('search'=>true,'sort'=>true)),
            array('PENDING COUNT',array('search'=>true,'sort'=>true)),
            array('PICTURES',array('search'=>false,'sort'=>true)),
            array('CURR POSITION',array('search'=>true,'select'=>Prefs::getPosition()->PositionToSelection('node_code','name') ,'sort'=>true)),
            array('LOGISTIC',array('search'=>true,'sort'=>true)),
        ...
        'default_delivered_fields'=>array(
            ...
            array('status',array('kind'=>'text','callback'=>'statusList','query'=>'like','pos'=>'both','show'=>true, 'multi'=>array('status','warehouse_status','pickup_status'), 'multirel'=>'OR'  )),
            array('logistic_status',array('kind'=>'text' , 'query'=>'like', 'pos'=>'both','show'=>true)),
            array('logistic_pickup_time',array('kind'=>'text' , 'query'=>'like', 'pos'=>'both','show'=>true)),
            array('logistic_last_note',array('kind'=>'text' , 'query'=>'like', 'pos'=>'both','show'=>true)),
            array('pending_count',array('kind'=>'numeric' , 'query'=>'like', 'pos'=>'both','show'=>true)),
            array('pending_count',array('kind'=>'text','callback'=>'picList' , 'query'=>'like', 'pos'=>'both','show'=>true)),
            array('position',array('kind'=>'text' , 'query'=>'like', 'pos'=>'both','show'=>true)),
            array('logistic',array('kind'=>'text' , 'query'=>'like', 'pos'=>'both','show'=>true)),
