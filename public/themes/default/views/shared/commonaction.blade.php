...
<br />
<a class="btn btn-transparent btn-info btn-sm" id="change_status"><i class="fa fa-user"></i> Change Delivery Status</a>
<a class="btn btn-transparent btn-info btn-sm" id="change_hub_status"><i class="fa fa-home"></i> Change Warehouse / Hub Status</a>
<a class="btn btn-transparent btn-info btn-sm" id="change_courier_status"><i class="fa fa-user"></i> Change Courier Status</a>
