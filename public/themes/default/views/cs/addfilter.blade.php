...
<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2" style="padding-top:50px;">
    <button class="btn btn-transparent btn-info btn-sm" id="search_orders"><i class="fa fa-search"></i> Search</button> <span id="search_clear" class="btn btn-sm btn-transparent" >Clear</span>
</div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#download-awb-xls').on('click',function(){
            ...
            console.log(sort);
            $.post('{{ URL::to('/') }}',{'filter' : dlfilter, 'sort':sort[0], 'sortdir' : sort[1] }, function(data) {
                if(data.status == 'OK'){
